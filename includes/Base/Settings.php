...
class Settings {
    ...
    public function register() {
        add_filter('wp_generate_attachment_metadata', array($this, 'redirectToS3'), 10, 2);
        add_filter('wp_get_attachment_url', array($this, 'replaceUrl'), 10, 2);
    }
     ...
     * @return bool
     */
    public function redirectToS3($metadata, $attachmentID, $sync = false) {
     ...
     * @return bool
     */
    public function s3HandleUpload($attachmentID, $filePath, $s3Key) {
     ...
     * @return string
     */
    public function replaceUrl($url, $attachmentID) {
    ...
    public function checkAndRenameAttachment($attachmentID) {
    ...
    private function generateResizedImageName($sizeFile) {
